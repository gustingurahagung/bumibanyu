...
const dataBarChart = {
    ...
    datasets: [{
      label: "Penjualan",
      data: [100, 250, 180, 320, 200],
      backgroundColor: ["#3366CC", "#FFCC99", "#66CC33", "#9933FF", "#CC3399"],
    }]
  };
  ...
  const dataPieChart = {
    ...
    datasets: [{
      data: [30, 25, 20, 15],
      backgroundColor: ["#3366CC", "#FFCC99", "#66CC33", "#9933FF"],
    }]
  };
...
const xData = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50];
const yData = [25, 30, 40, 35, 50, 45, 20, 35, 55, 40];
